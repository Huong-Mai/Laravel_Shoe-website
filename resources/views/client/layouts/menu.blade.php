  ...
  <div class=" collapse  navbar-collapse" id="navbarTogglerDemo02">
    ...
    @foreach($category as $cate)
     <li class="nav-item border-right dropdown">
      <!-- cate/{{$cate->id}} -->
      <a class="nav-link dropdown-toggle" href="cate/{{$cate->id}}" id="navbardrop" data-toggle="dropdown" style="color:
      #FEFCFC ">
          {{ $cate -> name}}
      </a>
                                    ...
                                    <div class="modal-body">
                                        <form action="updatepass" method="post">
                                            ...
                                            <div class="right-w3l">
                                                ...
                                                #000000 ; color: white" value="Cập nhật">
                                            </div>
                                        </form>
                                    </div>
                                </div>
        ...
        <div class="modal-body">
          <form action="{{  route('login') }}" method="post">
            ...
            <div class="right-w3l">
              <div class="row">
                <div class="col-md-6">
                <input type="submit" class="form-control" style="background-color: #000 ; color: white" value="Đăng Nhập">  
                </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{  route('register') }}" method="post">
            ...
            <div class="right-w3l">
              <input type="submit" class="form-control  register" style="background-color: #000 ; color: white" value="Đăng Ký">
