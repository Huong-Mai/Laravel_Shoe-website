...
<div class="nameproduct font-italic" style="background-color:#fff">
  ...
  @foreach($proty as $tyy)
        <h3 style="text-align: center;color: #000; margin: auto;" > Sản phẩm {{$tyy->name}}</h3>
        @endforeach
 </div>
  ...
  <div class="col-sm-6 col-md-4 ">
    <div class="thumbnail">
      ...
      <div class="caption ">
        ...
        <del style="text-align: center;color: #fff">{{ number_format($ty->price) }} đ</del>
      @else
        <span class="item_price" style="text-align: center">
      ...
      @endif
        ...
        <p style="text-align:center "><a href="{{route('san-pham',['id'=>$ty->id])}}" class="btn btn-primary" role="button">Chi tiết</a> 
...
<div class="nameproduct font-italic" style="background-color:#FFF">
    <!-- <h2 style="text-align: center;color: white" >@if(isset($nike)) {{ $nike[0]->categories->name }} @endif</h2> -->
  @foreach($proty as $tyy)
        <h3 style="text-align: center;color: #000; margin: auto;" > Sản Phẩm Khác</h3>
        @endforeach
 </div>
<!--  <h2 class="heading-tittle text-center font-italic nameproduct">@if(isset($nike)) {{ $nike[0]->categories->name }} @endif</h2> -->
  ...
  <div class="col-sm-6 col-md-4 ">
    <div class="thumbnail">
      ...
      <div class="caption ">
        ...
        <del style="text-align: center;color: white">{{ number_format($ty1->price) }} đ</del>
      @else
        <span class="item_price" style="text-align: center">
