  ...
  <div class="col-sm-6 col-md-4 ">
    <div class="thumbnail">
      ...
      @endif
        ...
        <p style="text-align:center "><a href="#" class="btn btn-secondary" role="button">Chi tiết</a> 
         <a href="{{route('addCart',['id'=>$ty->id]) }}" class="btn btn-info" role="button">Thêm giỏ hàng</a></p>
      </div>
    </div>
  </div>
